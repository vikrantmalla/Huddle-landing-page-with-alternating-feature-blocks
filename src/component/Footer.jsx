...
const Footer = () => {
    return (
        <>
            <footer className="bg-VeryDarkCyan pt-36 pb-14 px-6 flex flex-col gap-4 md:flex-row justify-between items:center lg:px-20">
                <div className="flex flex-col gap-4 md:w-2/6" >
                    ...
                    <div className="flex flex-row gap-3">
                        ...
                        <p className="text-white text-xs font-OpenSans font-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                    </div>
                    <div className="flex flex-row gap-3 ">
