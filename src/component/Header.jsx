    ...
    return (
        <>
            <header className='bg-VeryPaleCyan bg-mobile-pattern md:bg-desktop-pattern lg:px-20 py-10'>
                <nav className='flex flex-row justify-between p-6 md:mx-6'>
                    <img className="w-2/5 md:w-2/12" src="./images/logo.svg" alt="logo" />
                    <button className="bg-white text-black font-Poppins font-medium text-sm rounded-full px-6 py-2 shadow shadow-gray-400 hover:opacity-70 md:py-3">Try It Free</button>
                </nav>
                <section className='my-8 p-4 grid grid-rows-1 justify-center items-center gap-10 md:px-16 lg:grid-cols-2'>
                    ...
                    <img src="./images/illustration-mockups.svg" alt="mockups"></img>
                </section>
            </header>
            <section></section>
        </>
